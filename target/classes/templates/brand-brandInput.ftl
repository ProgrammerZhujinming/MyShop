 ...
 <table id="table_bug_report" class="table table-striped table-bordered table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>${bl.bname}</td>
          <td><img src="/image/${bl.blogo}"  width="160" alt="" /></td>
          <td>
            <div class="inline position-relative">
              ...
              <div class="modal-dialog" role="document">
                  <div class="modal-content">
                      ...
                      <div class="modal-body" >
                          <form class="form-horizontal" action="/addBrand" method="post">

                              <div class="control-group">
                                  <label class="control-label">品牌名称<br>Brand Name</label>
                                  <div class="controls">
                                      <input type="text" id="bname" name="bname" >
                                      <input type="hidden" value="${Session["company"].cid}" id="cid" name="cid">
                                  </div>
                              </div>

                              <div class="control-group">
                                  <p class="red">(建议图片大小160*80的jpg/png格式)</p>
                                  <label class="control-label">品牌图片<br>Brand Logo</label>
                                  <div class="controls">
                  ...
                  <div>
                      ...
                      <!--<input type="submit" value="开始上传" id="ctlBtn" class="btn btn-default"></input>-->
                  </div>
                  </div>
                  </span>
                                  </div>
                              ...
                              <div class="modal-footer">
                                  ...
                                  <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="pic_save()">保存</button>
                              </div>
                          </form>
                      </div>
                  </div>
...
/!*            var formData=new FormData();
            formData.append("file",$("#blogo")[0].files[0]);
